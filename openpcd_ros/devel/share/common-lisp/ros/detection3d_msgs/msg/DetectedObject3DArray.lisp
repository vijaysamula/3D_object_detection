...
(cl:defclass <DetectedObject3DArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (objects
    :reader objects
    :initarg :objects
    :type (cl:vector detection3d_msgs-msg:DetectedObject3D)
   :initform (cl:make-array 0 :element-type 'detection3d_msgs-msg:DetectedObject3D :initial-element (cl:make-instance 'detection3d_msgs-msg:DetectedObject3D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObject3DArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObject3DArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detection3d_msgs-msg:<DetectedObject3DArray> is deprecated: use detection3d_msgs-msg:DetectedObject3DArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <DetectedObject3DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection3d_msgs-msg:header-val is deprecated.  Use detection3d_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <DetectedObject3DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection3d_msgs-msg:objects-val is deprecated.  Use detection3d_msgs-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectedObject3DArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'detection3d_msgs-msg:DetectedObject3D))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObject3DArray>)))
  ...
  "detection3d_msgs/DetectedObject3DArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObject3DArray)))
  "Returns string type for a message object of type 'DetectedObject3DArray"
  "detection3d_msgs/DetectedObject3DArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DetectedObject3DArray>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%DetectedObject3D[] objects~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: detection3d_msgs/DetectedObject3D~%string name~%OrientedBox box~%================================================================================~%MSG: detection3d_msgs/OrientedBox~%# Pose = position of centroid of object + orientation of object.~%geometry_msgs/Pose pose~%~%# Dimensions of the box.~%float64 width~%float64 height~%float64 depth~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DetectedObject3DArray)))
  "Returns full string definition for message of type 'DetectedObject3DArray"
  (cl:format cl:nil "std_msgs/Header header~%DetectedObject3D[] objects~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: detection3d_msgs/DetectedObject3D~%string name~%OrientedBox box~%================================================================================~%MSG: detection3d_msgs/OrientedBox~%# Pose = position of centroid of object + orientation of object.~%geometry_msgs/Pose pose~%~%# Dimensions of the box.~%float64 width~%float64 height~%float64 depth~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
