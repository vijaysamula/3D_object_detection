...
(cl:defmethod cl:initialize-instance :after ((m <OrientedBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OrientedBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detection3d_msgs-msg:<OrientedBox> is deprecated: use detection3d_msgs-msg:OrientedBox instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <OrientedBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection3d_msgs-msg:pose-val is deprecated.  Use detection3d_msgs-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <OrientedBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection3d_msgs-msg:width-val is deprecated.  Use detection3d_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <OrientedBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection3d_msgs-msg:height-val is deprecated.  Use detection3d_msgs-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <OrientedBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection3d_msgs-msg:depth-val is deprecated.  Use detection3d_msgs-msg:depth instead.")
  (depth m))
