...
(cl:defclass <DetectedObject3D> (roslisp-msg-protocol:ros-message)
  ((name
   ...
   (box
    :reader box
    :initarg :box
    :type detection3d_msgs-msg:OrientedBox
    :initform (cl:make-instance 'detection3d_msgs-msg:OrientedBox)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObject3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObject3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detection3d_msgs-msg:<DetectedObject3D> is deprecated: use detection3d_msgs-msg:DetectedObject3D instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <DetectedObject3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection3d_msgs-msg:name-val is deprecated.  Use detection3d_msgs-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'box-val :lambda-list '(m))
(cl:defmethod box-val ((m <DetectedObject3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection3d_msgs-msg:box-val is deprecated.  Use detection3d_msgs-msg:box instead.")
  (box m))
