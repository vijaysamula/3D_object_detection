...
from utils import remove_low_score_nu
...
class InferenceModel:
    ...
    def infer(self,points):
        ...
        torch.cuda.synchronize()
        print(f" pvrcnn inference cost time: {time.time() - now}")

        pred = remove_low_score_nu(pred_dicts[0], self.threshold_score)
